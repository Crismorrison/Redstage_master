...
class Save extends \Redstage\Banner\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('redstage_banner/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('redstage_banner/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('redstage_banner/*/new');
                }
                return;
            } catch (\Exception $e) {
